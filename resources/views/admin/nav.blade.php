...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Admin - Impulso MEI')</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="{{ route('admin.usuarios') }}" class="{{ request()->routeIs('admin.usuarios') ? 'active' : '' }}">
    ...
    <div class="">
     <img src="{{ asset('/logotipos/impulsoMei.png') }}" alt="Impulso MEI" class="rounded-circle" style="width:56px;height:56px;object-fit:cover;border:2px solid #fbcfe8;">
     </div>
    </header>
